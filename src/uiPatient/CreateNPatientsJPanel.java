 ...
 */
public class CreateNPatientsJPanel extends javax.swing.JPanel {
    
    /**
     * Creates new form CreateNPatientsJPanel
     */
    private PersonDetails person;
    private JPanel userProcessContainer;
    
    public CreateNPatientsJPanel(JPanel upc, PersonDetails person) {
        initComponents();
    ...
    private void addPatientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPatientJButtonActionPerformed
        ...
        if (checkBlankInput())
        {
            ...
            patient.setPatient_Identity(patientIDJTextField.getText());

...
public class ManagePatientsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        searchCommunityBtn = new javax.swing.JButton();
        searchCommunity = new javax.swing.JTextField();
        lblCommunitySearch = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        countAbnormal = new javax.swing.JTextField();
        ...
        searchCommunityBtn.setText("Search");
        searchCommunityBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchCommunityBtnActionPerformed(evt);
            }
        });
        ...
        lblCommunitySearch.setText("Community");

        jLabel3.setText("Count of Abnormal cases");

        countAbnormal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                countAbnormalActionPerformed(evt);
            }
        });

        jLabel4.setText("Count of abnormal cases by community");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(17, 17, 17)
                        .addComponent(lblCommunitySearch)
                        .addGap(18, 18, 18)
                        .addComponent(searchCommunity, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel4)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(searchCommunityBtn)
                                .addGap(29, 29, 29)
                                .addComponent(jLabel3)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(countAbnormal, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(searchCommunityBtn)
                    .addComponent(searchCommunity, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblCommunitySearch)
                    .addComponent(jLabel3)
                    .addComponent(countAbnormal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void viewPatientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewPatientJButtonActionPerformed
        ...
        PersonDetails person=(PersonDetails) viewPersonsJTable.getValueAt(selectedRow, 0);
    ...
    private void searchPatientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchPatientJButtonActionPerformed
        ...
        ArrayList<PersonDetails> searchPatients;
    ...
    private void createPatientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createPatientJButtonActionPerformed
        ...
        CreateNPatientsJPanel cpJPanel= new CreateNPatientsJPanel(userProcessContainer, person);
        userProcessContainer.add("cpJPanel", cpJPanel);
        CardLayout layout=(CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_createPatientJButtonActionPerformed

    private void searchCommunityBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchCommunityBtnActionPerformed
        String key= searchCommunity.getText().trim();
        if(key.length()==0)
        {
            JOptionPane.showMessageDialog(this, "Please enter key.", "Error",
                    JOptionPane.ERROR_MESSAGE);
        ...
        ArrayList<PersonDetails> searchPatients;
        searchPatients=personDirectory.searchCommunity(key);
        countAbnormal.setText(String.valueOf(searchPatients.size()));
        populatePatientsTable(searchPatients);
    }//GEN-LAST:event_searchCommunityBtnActionPerformed
    ...
    private void countAbnormalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_countAbnormalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_countAbnormalActionPerformed
    

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton backJButton;
    private javax.swing.JTextField countAbnormal;

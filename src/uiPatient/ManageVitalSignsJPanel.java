...
public class ManageVitalSignsJPanel extends javax.swing.JPanel {
    ...
    public ManageVitalSignsJPanel(JPanel userProcessContainer, PersonDirectory personDirectory) {
        ...
        ArrayList<PersonDetails> personList = personDirectory.getPersonHistory();
        populatePatientsTable(personList);
        populateVitalSignTable(null);
    }
    
    private void populatePatientsTable(ArrayList<PersonDetails> personList) {
        ...
        for (PersonDetails person : personList) {
            ...
            {
                row[2] = person.getPatient().getPatient_Identity();
            }
            else
            {
    ...
    private void populateVitalSignTable(PersonDetails person) {
        ...
        if (person != null) {
            ...
            for (VitalSigns vitalSign : vitalSignList) {
                ...
                row[0] = vitalSign;
                row[1] = VitalSignStatus(person.getPatient(),patientAge, vitalSign);
                model.addRow(row);
            }
        }
    }
    ...
    private void addVitalSignsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addVitalSignsJButtonActionPerformed
        ...
        PersonDetails person = (PersonDetails) viewPatientsJTable.getValueAt(selectedRow, 0);
        PatientDetails patient= person.getPatient();
        if(patient!=null)
        {
            CreateVitalSignsJPanel cvsJPanel = new CreateVitalSignsJPanel(userProcessContainer, patient,person.getAge());
    ...
    private void searchPatientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchPatientJButtonActionPerformed
        ...
        ArrayList<PersonDetails> searchPatients = personDirectory.searchPatient(key);
